...
const HERO_IMAGES = [
  ...
  { src: "/hero-sale-7.png",  position: "80% 35%", mobilePosition: "68% 40%" } // 新增最後一張
];
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #e8f4f8 0%, #f0f4f8 50%, #fce4ec 100%)", fontFamily: "'Noto Sans TC', 'PingFang TC', sans-serif" }}>
      {/* Header */}
      <div style={{ background: "linear-gradient(180deg, #eaf1f5 0%, #ffffff 100%)", boxShadow: "0 2px 12px rgba(0,0,0,0.08)", position: "sticky", top: 0, zIndex: 100 }}>
