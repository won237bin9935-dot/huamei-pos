...
const firebaseConfig = {
  apiKey: "AIzaSyCF0Pkxn6s0Dhwl2DbVhbNQQPvR4bP13GU",
  authDomain: "huamei-pos.firebaseapp.com",
  databaseURL: "https://huamei-pos-default-rtdb.asia-southeast1.firebasedatabase.app",
  projectId: "huamei-pos",
  storageBucket: "huamei-pos.firebasestorage.app",
  messagingSenderId: "936665949732",
  appId: "1:936665949732:web:85526c1f91fb9ae444dab1"
};
              ...
              return (
                <div key={p.id} style={{ background: "white", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 12px rgba(0,0,0,0.08)", transition: "transform 0.2s, box-shadow 0.2s", cursor: p.stock <= 0 ? "default" : "pointer", filter: p.stock <= 0 ? "grayscale(40%)" : "none", opacity: p.stock <= 0 ? 0.9 : 1, border: isLow ? "2px solid #ff7043" : "2px solid transparent" }}
                  ...
                  <div style={{ height: 140, overflow: "hidden", position: "relative" }} onClick={() => setSelectedProduct(p)}>
                    <div style={{ position: "absolute", top: 8, left: 8, zIndex: 2, background: "rgba(26,43,60,0.75)", color: "white", fontSize: 11, fontWeight: 800, padding: "2px 8px", borderRadius: 20, backdropFilter: "blur(4px)" }}>No.{String(products.indexOf(p) + 1).padStart(2, "0")}</div>
                    {p.image
      ...
      <div style={{ background: "white", boxShadow: "0 2px 12px rgba(0,0,0,0.08)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <img src="data:image/png;base64," alt="華美光學" style={{ width: 52, height: 52, objectFit: "contain" }} />
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ fontWeight: 800, fontSize: 20, color: "#1a2b3c" }}>華美光學</span>
                <span style={{ fontWeight: 800, fontSize: 20, color: "#1a2b3c" }}>員工特賣會</span>
              </div>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            {view === "admin" ? (
